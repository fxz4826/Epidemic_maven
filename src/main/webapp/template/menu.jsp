    ...
    <div class="panel panel-primary">
        ...
        <div id="div1" class="panel-collapse in">
            <div class="list-group">
                ...
                <a href="${pageContext.request.contextPath}/epidemic_data.jsp"  target="imain" class="list-group-item">数据查询</a>
                <a href="${pageContext.request.contextPath}/epidemic.jsp"  target="imain"  class="list-group-item">图表展示</a>
            </div>
        </div>
    </div>
    <div class="panel panel-primary">
